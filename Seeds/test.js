  ...
  return knex("ratings")
    ...
    .then(function () {
      ...
      return knex("ratings").insert([
        ...
        { tap_id: 197443, star: 5, comment: "Water tastes nice" },
        { tap_id: 197443, star: 5, comment: "店員さんが可愛い" },
        { tap_id: 197443, star: 4, comment: "Will go again" },
        { tap_id: 197501, star: 4, comment: "Good" },
        { tap_id: 196864, star: 4, comment: "Good" },
        { tap_id: 198374, star: 5, comment: "Potato and Fudgi 🐶" },
        { tap_id: 198374, star: 2, comment: "Water tastes like JavaScript" },
        { tap_id: 198374, star: 4, comment: "I could see codes in my water" },
        { tap_id: 198374, star: 5, comment: "They have cute dogs" },
        { tap_id: 198374, star: 3, comment: "I couldn't get hot water :(" },
